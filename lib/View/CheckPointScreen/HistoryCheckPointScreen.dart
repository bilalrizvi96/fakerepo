...
class HistoryLIst extends StatelessWidget {
  const HistoryLIst({
    Key? key,
    required CheckPointController checkPointController,
    ...
    return RepaintBoundary(
      ...
      child: _checkPointController.Loading.value == false
          ? _checkPointController.historyList.value.isNotEmpty
              ? ListView.builder(
                  itemCount: _checkPointController.historyList.value.length,
                  shrinkWrap: true,
                  itemBuilder: (_, index) {
                    return Center(
                      child: Padding(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              _checkPointController.historyList
