                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    DatePicker.showDatePicker(context,
                                        minTime: DateTime(
                                            int.parse(
                                                _checkPointController.year),
                                            int.parse(
                                                _checkPointController.month),
                                                                    ...
                                                                    ? Row(
                                                                        children: [
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                                Text(
                                                                              _checkPointController.historyList.value[index].notes != null ? _checkPointController.historyList.value[index].notes : '',
                                                                              maxLines: 3,
                                                                              style: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: width / 30, color: DynamicColor().titletextcolor),
                                                                            ),
                                                                          )
                                                                        ],
                                                                      )
                                                                ...
                                                                child:
                                                                        ...
                                                                        builder: (_) =>
                                                                            AlertDialog(
                                                                              actions: [
                                                                                ...
                                                                                CachedNetworkImage(
                                                                                  imageUrl: _checkPointController.historyList.value[index].image,
                                                                                  fit: BoxFit.cover,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Container(
                                                                        width: width / 6,
                                                                        height: height / 9,
                                                                        decoration: BoxDecoration(color: DynamicColor().white, borderRadius: BorderRadius.circular(13.0)),
