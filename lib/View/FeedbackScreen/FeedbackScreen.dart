    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GetBuilder(
            ...
            builder: (_) {
              return _feedbackController.connection == true
                  ? Padding(
                      ...
                      child: Stack(
                        children: [
                          ...
                          _feedbackController.Loading == false
                              ? _feedbackController.connection == true
                                  ? Column(
                                      crossAxisAlignment:
